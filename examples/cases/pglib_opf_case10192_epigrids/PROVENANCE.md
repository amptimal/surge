# PGLib EPIGRIDS 10192 Bundle Provenance
...
- Case lineage: EPIGRIDS synthetic benchmark data distributed through PGLib-OPF
...
- `pglib_opf_case10192_epigrids.surge.json.zst` is the canonical checked-in
  Surge artifact.
...
3. Regenerate `pglib_opf_case10192_epigrids.surge.json.zst`.
