# RTE 6470 Bundle Provenance

This bundle packages a first-party Surge representation of `case6470rte`.

## Upstream Reference

- Public reference dataset: MATPOWER case library, `case6470rte`
...
- `case6470rte.surge.json.zst` is the canonical checked-in Surge artifact for
  this bundle.
...
1. Start from an approved public upstream source for `case6470rte`.
2. Convert/import it into Surge.
3. Regenerate `case6470rte.surge.json.zst`.
