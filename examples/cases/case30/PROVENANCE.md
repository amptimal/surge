# IEEE 30-Bus Bundle Provenance

This bundle packages a first-party Surge representation of `case30`.
...
- Common case-file lineage: MATPOWER `case30`
...
- `case30.surge.json.zst` is the canonical checked-in Surge artifact for this
  bundle.
- The repository does not intentionally ship the MATPOWER-distributed
  `case30.m` wrapper text verbatim.

## Refresh Procedure

1. Start from an approved public upstream source for the IEEE 30-bus dataset.
2. Convert/import it into Surge.
3. Regenerate `case30.surge.json.zst`.
