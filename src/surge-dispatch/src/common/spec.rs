...
pub(crate) struct DispatchProblemSpec<'a> {
    ...
    pub peak_demand_charges: &'a [crate::dispatch::IndexedPeakDemandCharge],
...
impl<'a> DispatchProblemSpec<'a> {
    ...
    fn from_request_parts(
        ...
        peak_demand_charges: &'a [crate::dispatch::IndexedPeakDemandCharge],
        ...
        'a: 'b,
    {
        DispatchProblemSpec {
            ...
            peak_demand_charges: self.peak_demand_charges,
